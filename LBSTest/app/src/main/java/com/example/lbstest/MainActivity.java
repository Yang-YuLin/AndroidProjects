...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocationClient=new LocationClient(getApplicationContext());//getApplicationContext()方法获取全局的Context参数
    ...
    private void requestLocation(){
        initLocation();
        mLocationClient.start();//此结果会回调到前面注册的监听器当中
    }

    private void initLocation(){
        LocationClientOption option = new LocationClientOption();
        option.setScanSpan(5000);//设置更新的间隔，表示每5秒钟会更新一下当前的位置
    ...
    public class MyLocationListener implements BDLocationListener{
        ...
        public void onReceiveLocation(BDLocation location){
            /*StringBuilder currentPosition = new StringBuilder();//将结果封装成一个字符串，显示到TextView上面
